        ...
        <div class="container my-order-box" style="height: 100vh; width: 100vw; margin-top: 40px;">
            ...
            <div class="row my-order-box-content">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="manageorder">All</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="manageorder?status=-2">Cancel</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="manageorder?status=-1">Declined</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="manageorder?status=0">Awaiting to confirm</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="manageorder?status=1">Confirm to ship</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="manageorder?status=2">Success</a>
                    </li>
                </ul>
                                ...
                                <div class="button-box">
                                    ...
                                    <c:choose>
                                        <c:when test="${i.order_status == 0}">
                                            <button class="btn-approved" status="1" order_id="${i.order_id}">Approved</button>
